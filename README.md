...
* Developed a data-oriented system for interactive game objects (e.g. books) with data table using Enums as Keys, allowing narrative and level designers to update content without code changes
...
## [The Bookworm](https://github.com/Ksoucha/Bookworm_ScreamJam2024) - submission for the ScreamJam2024 game jam
_Made with Unity in 3D in C#_
